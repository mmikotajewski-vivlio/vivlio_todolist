        ...
        if(currentArg == "-h" || currentArg == "--help") {
            std::cout << "Program name : vivtodo\n"
                << "Description : Super todo list management\n"
                    ...
                    "\t\t If no option is provided, just displays the list of items in the TODO list with their ID, sorted by priority (urgents, normally urgent, not urgent, done)"  << std::endl;
        } //else if ()
    }
